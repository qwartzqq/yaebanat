...
const footerLinks = {
  product: [
    ...
    // /api is reserved for route handlers, use a docs page instead
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="https://t.me/oarew" className="font-display text-xl font-semibold text-zinc-100">
              Pale
            </Link>
        ...
        <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">© {new Date().getFullYear()} Pale Inc. All rights reserved.</p>
